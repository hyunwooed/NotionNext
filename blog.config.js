...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '93b6e43c1cc240448bd9ea0e825e9fa2',
  ...
  GREETING_WORDS:
    ...
    'Welcome to hyunwoo.org!',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Hyunwoo Jo', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'My name is Hyunwoo Jo (조현우), a student majoring in Global Affairs at George Mason University Korea.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.hyunwoo.org', // 网站地址
  ...
  SEO_NAVER_SITE_VERIFICATION:
    process.env.NEXT_PUBLIC_SEO_NAVER_SITE_VERIFICATION || '', // Remove the value or replace it with your own google site verification code
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || 'Hyunwoo Jo', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION || 'Hyunwoo Jo | hyunwoo.org', // 站点描述，被notion中的页面描述覆盖
